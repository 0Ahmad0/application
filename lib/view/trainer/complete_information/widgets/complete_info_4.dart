...
class CompleteInfo4 extends StatelessWidget {
  final numberOfHourController = TextEditingController();
  final priceInYourCarController = TextEditingController();
  final priceInHerCarController = TextEditingController();
  final GlobalKey<FormState> formKey;
  final PageController pageController;


  CompleteInfo4({super.key, required this.formKey, required this.pageController});
